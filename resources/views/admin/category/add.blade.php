...
<form action="{{ asset('admin/category/add_check') }}" method="POST" enctype="multipart/form-data" class="mt-2">
  @csrf
  <div>
  ...
  <div class="mt-4">
    <input type="submit" value="Add Category" class="flex cursor-pointer w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" />
  </div>
</form>
@endsection